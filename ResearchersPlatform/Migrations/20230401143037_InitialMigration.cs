        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudentObjId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Badges", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Badges_Students_StudentObjId",
                        column: x => x.StudentObjId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResearcherCreatorId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    SpecalityId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    SpecalityObjId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ideas_Specalities_SpecalityObjId",
                        column: x => x.SpecalityObjId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Researchers_Students_Id",
                        column: x => x.Id,
                        principalTable: "Students",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Ideas_ResearcherCreatorId",
                table: "Ideas",
                column: "ResearcherCreatorId");

            migrationBuilder.CreateIndex(
                name: "IX_Ideas_SpecalityObjId",
                table: "Ideas",
                column: "SpecalityObjId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Ideas_Researchers_ResearcherCreatorId",
                table: "Ideas",
                column: "ResearcherCreatorId",
                principalTable: "Researchers",
                principalColumn: "Id");
